...
def train():
    ...
    model.save_pretrained(save_directory="./parallel_zero_ckpt")


if __name__ == "__main__":
    train()

# torchrun --nnodes=1  --nproc_per_node=4 --master_addr=localhost --master_port=12345 test_dp_zero.py
