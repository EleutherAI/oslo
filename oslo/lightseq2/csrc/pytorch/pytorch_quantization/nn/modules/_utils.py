...
from csrc.pytorch.pytorch_quantization.nn import TensorQuantizer
...
class QuantMixin:
    ...
    def set_default_quant_desc_input(cls, value):
        """
        Args:
            value: An instance of :class:`QuantDescriptor <csrc.pytorch.pytorch_quantization.tensor_quant.QuantDescriptor>`
        """
