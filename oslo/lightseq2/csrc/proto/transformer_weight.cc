...
*/
template <typename T>
void TransformerWeight<T>::proto_get_model_config(
...
*/
template <typename T>
void TransformerWeight<T>::hdf5_parse_enc_wei(hid_t hdf5_file) {
  size_t value_size =
...
*/
template <typename T>
void TransformerWeight<T>::hdf5_parse_dec_wei(hid_t hdf5_file) {
  size_t value_size =
      (_hidden_size * 2 + _hidden_size * _hidden_size * 3 + _hidden_size * 3 +
       _hidden_size * _hidden_size + _hidden_size * 3 +
