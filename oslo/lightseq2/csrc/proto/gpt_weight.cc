...
*/
template <>
float GptWeight<float>::float2required(float value) {
  return value;
}
...
*/
template <typename T>
void GptWeight<T>::hdf5_parse_emb_wei(hid_t hdf5_file) {
...
*/
template <typename T>
void GptWeight<T>::hdf5_parse_enc_wei(hid_t hdf5_file) {
  size_t value_size =
