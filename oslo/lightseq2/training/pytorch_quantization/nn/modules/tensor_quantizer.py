...
from oslo.lightseq2.training.pytorch_quantization.nn.modules.clip import Clip

from oslo.lightseq2.training.pytorch_quantization import calib

import oslo.lightseq2.training.pytorch_quantization.utils as quant_utils
...
class TensorQuantizer(nn.Module):
    ...
    Args:
        quant_desc: An instance of :func:`QuantDescriptor <oslo.lightseq2.training.pytorch_quantization.tensor_quant.QuantDescriptor>`.
        ...
        if_calib: A boolean. If True, run calibration. Not implemented yet. Settings of calibration will probably
            go to :func:`QuantDescriptor <oslo.lightseq2.training.pytorch_quantization.tensor_quant.QuantDescriptor>`.
