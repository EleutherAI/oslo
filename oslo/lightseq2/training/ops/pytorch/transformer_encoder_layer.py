...
from oslo.lightseq2.training.ops.pytorch.layer_base import TransformerEncoderLayerBase
from oslo.lightseq2.training.ops.pytorch.builder import TransformerBuilder
