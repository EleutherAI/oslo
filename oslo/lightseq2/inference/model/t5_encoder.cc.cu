...
*/
template <OperationType OpType_>
long T5Encoder<OpType_>::compute_buffer_bytesize() {
...
*/
template <OperationType OpType_>
void T5Encoder<OpType_>::init_buffer(void *pbuf) {
...
*/
template <OperationType OpType_> std::string T5Encoder<OpType_>::check() {
...
*/
template <OperationType OpType_>
void T5Encoder<OpType_>::run_one_infer(int batch_size, int batch_seq_len) {
...
*/
template <OperationType OpType_> void T5Encoder<OpType_>::self_attention() {
...
template <OperationType OpType_> void T5Encoder<OpType_>::ffn_add_norm() {
  /* ---step 0. layer_norm, add output_bias to "query"--- */
...
template class T5Encoder<OperationType::FP16>;
template class T5Encoder<OperationType::FP32>;
