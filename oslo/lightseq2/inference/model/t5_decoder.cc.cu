...
*/
template <OperationType OpType_>
long T5Decoder<OpType_>::compute_buffer_bytesize() {
...
*/
template <OperationType OpType_>
void T5Decoder<OpType_>::init_buffer(void *pbuf) {
...
*/
template <OperationType OpType_> std::string T5Decoder<OpType_>::check() {
...
*/
template <OperationType OpType_>
void T5Decoder<OpType_>::run_one_infer(int batch_size, int batch_seq_len) {
...
*/
template <OperationType OpType_>
void T5Decoder<OpType_>::project_encoder_output() {
...
Decode one step
*/
template <OperationType OpType_> bool T5Decoder<OpType_>::run_step() {
  embedding();
  decoder_stack();
...
Decode embedding
*/
template <OperationType OpType_> void T5Decoder<OpType_>::embedding() {
...
/**
T5Decoder feedforward, composed by self_atten,
  enc-dec-atten, ffn
*/
template <OperationType OpType_> void T5Decoder<OpType_>::decoder_stack() {
...
/**
T5Decoder self attention
*/
template <OperationType OpType_> void T5Decoder<OpType_>::self_attention() {
...
*/
template <OperationType OpType_> void T5Decoder<OpType_>::encdec_attention() {
  /* ---step 0. layer_norm, add output_bias to "query"--- */
...
template <OperationType OpType_> void T5Decoder<OpType_>::ffn_add_norm() {
  /* ---step 0. layer_norm, add output_bias to "query"--- */
...
template <OperationType OpType_> bool T5Decoder<OpType_>::sample() {
  CHECK_GPU_ERROR(
...
template <OperationType OpType_> bool T5Decoder<OpType_>::beam_search() {
  /*
...
*/
template <OperationType OpType_>
void T5Decoder<OpType_>::update_new_seq_probs() {
  CHECK_GPU_ERROR(cudaMemsetAsync(_p_d_can_num, 0, sizeof(int), _stream));
...
template <OperationType OpType_> bool T5Decoder<OpType_>::topk_greedy_search() {
...
template class T5Decoder<OperationType::FP16>;
template class T5Decoder<OperationType::FP32>;
