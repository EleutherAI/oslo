...
from ._base_grad_scaler import BaseGradScaler
...
class DynamicGradScaler(BaseGradScaler):
    ...
    Args:
        ...
        growth_interval (int): 
            The number of steps to increase loss scale when no overflow occurs, defaults to 1000
        min_scale (float): 
            Te minimum loss scale, defaults to None
        max_scale (float): 
            The maximum loss scale, defaults to None
        hysteresis (int):  
            The number of overflows before decreasing loss scale, defaults to 2
        verbose (bool): 
            Whether to log messages, defaults to False
    """
