...
class ColoModule(object):
    def __init__(self):
        ...
        self._allowed_patterns: Dict[
            ComputePattern, Dict[str, Dict[str, _DistSpec]]
        ] = {}
    ...
    def _set_default(self, compute_pattern: ComputePattern, target_mode):
        self._allowed_patterns[compute_pattern]["default"] = self._allowed_patterns[
            compute_pattern
        ][target_mode]
    ...
    def has_compute_pattern_with_mode(
        self, compute_pattern: ComputePattern, mode="default"
    ):
        return (
            compute_pattern in self._allowed_patterns
            and mode in self._allowed_patterns[compute_pattern]
        )
