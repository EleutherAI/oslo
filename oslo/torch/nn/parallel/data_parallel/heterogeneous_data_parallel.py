...
from oslo.torch.nn.parallel.data_parallel.zero.heterogeneous_manager.chunk import init_chunk_manager
...
from oslo.torch.nn.parallel.data_parallel.zero.heterogeneous_manager.memory_tracer import MemStats

from oslo.torch.nn.parallel.data_parallel.fully_sharded_data_parallel import _FullyShardedDataParallel
...
class _HeterogeneousDataParallel(_FullyShardedDataParallel):
    ...
    def __init__(self,
        ...
        """
        A torch.Module warpper using ZeRO-DP and HeterogeneousMemoryManager.
        ...
        heterogeneous_manager = HeterogeneousMemoryManager(placement_policy, chunk_manager, memstats)
        super().__init__(module, heterogeneous_manager, parallel_context, pin_memory, force_outputs_fp32, strict_ddp_mode)