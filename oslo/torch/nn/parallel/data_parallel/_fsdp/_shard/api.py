...
from oslo.torch.nn.parallel.data_parallel._fsdp._shard.partial_tensor import (
    _PartialTensor,
)
from oslo.torch.nn.parallel.data_parallel._fsdp._shard.replicated_tensor import (
    ReplicatedTensor,
)
from oslo.torch.nn.parallel.data_parallel._fsdp._shard.sharded_tensor import (
    ShardedTensor,
)
from oslo.torch.nn.parallel.data_parallel._fsdp._shard.sharder import Sharder
from oslo.torch.nn.parallel.data_parallel._fsdp._shard.sharding_plan import ShardingPlan
from oslo.torch.nn.parallel.data_parallel._fsdp._shard.sharding_spec import (
    ShardingSpec,
    ChunkShardingSpec,
)
    ...
    def hook_func(_module, _input, output):
        if isinstance(output, ShardedTensor):
            ...
            if (
                ...
                and local_tensor.size(sharding_spec.dim) == 1
