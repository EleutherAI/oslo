...
def initialize(float_module_list=None, custom_quant_modules=None):
    ...
    Typical usage example:
        ...
        lightseq.training.pytorch_quantization.quant_modules.initialize(float_module_list, custom_modules)
        ## Use the quantized modules
        lightseq.training.pytorch_quantization.quant_modules.deactivate()
    """
