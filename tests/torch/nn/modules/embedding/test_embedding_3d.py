"""
torchrun --nproc_per_node=4 test_embedding_3d.py
"""
...
def test_embedding_3d(pc):
    ...
    w = split_embedding_3d(w, cubic_dim, parallel_context=pc)

    embedding_3d = Embedding3D(num_embeddings, embedding_dim, parallel_context=pc)
    embedding_3d.weight.data.copy_(w)
...
if __name__ == "__main__":
    ...
    if pc.get_global_rank() == 0:
        print("Test tests/torch/nn/modules/embedding/test_embedding_3d.py")
    test_embedding_3d(pc)
