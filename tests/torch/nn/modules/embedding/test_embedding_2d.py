...
def test_embedding_2d(pc):
    ...
    w = split_embedding_2d(w, summa_dim, parallel_context=pc)

    embedding_2d = Embedding2D(16, 8, parallel_context=pc)
    embedding_2d.weight.data.copy_(w)
...
if __name__ == "__main__":
    ...
    if pc.get_global_rank() == 0:
        print("Test tests/torch/nn/modules/embedding/test_embedding_2d.py")
    test_embedding_2d(pc)
