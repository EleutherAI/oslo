"""
torchrun --nproc_per_node=4 test_layer_norm_2d.py
"""
...
def test_layer_norm_2d(pc):
    ...
    w = split_layernorm_2d(w, summa_dim, parallel_context=pc)
    b = split_bias_2d(b, summa_dim, parallel_context=pc)

    layernorm_2d = LayerNorm2D(hidden_dim, parallel_context=pc)
...
if __name__ == "__main__":
    ...
    if pc.get_global_rank() == 0:
        print("Test tests/torch/nn/modules/layer_norm/test_layer_norm_2d.py")
    test_layer_norm_2d(pc)
