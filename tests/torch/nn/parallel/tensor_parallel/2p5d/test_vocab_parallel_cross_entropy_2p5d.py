...
from _utils import split_2p5d
from oslo.torch.distributed import ParallelContext, ParallelMode
from oslo.torch.nn import VocabParallelCrossEntropyLoss2p5D
...
criterion = VocabParallelCrossEntropyLoss2p5D(parallel_context=parallel_context)
...
out = split_2p5d(out_master.clone(), tesseract_dim, parallel_context=parallel_context)
out = out.clone()
...
grad_master = split_2p5d(grad_master, tesseract_dim, parallel_context=parallel_context)
grad = out.grad
