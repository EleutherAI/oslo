...
from transformers import AutoTokenizer, GPT2Config, GPT2LMHeadModel, T5Config, T5ForConditionalGeneration
...
# 모델 생성 및 병렬화 수행
model_no_tp = T5ForConditionalGeneration(T5Config.from_pretrained(model_name)).cuda()
model_tp = T5ForConditionalGeneration(T5Config.from_pretrained(model_name))
